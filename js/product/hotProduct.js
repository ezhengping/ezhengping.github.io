        ...
        function ajaxHotProductHtml(pageNo) {
            var url = PATH+'/product/queryHotProduct.action'
            $.ajax({
                    url: url,
                    type: 'GET',
                    data: {
        ...
        function topInbottom(length) {
            ...
            $(window).scroll(function() {
                ...
                ajaxHotProductHtml(pageNo)
                
            });
        }

        function addHotProductData(data) {
            var html = '';
            var bannerHtml ='<a class="header__banner__ul_item_link" href="javasript:;">'+
